...
function setup() {
  ...
  invisibleGround1 = createSprite(displayWidth / 2 - 20,displayHeight / 2 - 400, width,20)
  invisibleGround2 = createSprite(displayWidth / 2 - 750,displayHeight / 2 - 100, 10,800)
  invisibleGround3 = createSprite(displayWidth / 2 -20,displayHeight - 140, width , 20);
  invisibleGround4 = createSprite(displayWidth  -70,displayHeight / 2 - 100, 10, 970);
